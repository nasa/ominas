...
;
;=============================================================================
function grim_select_overlays, grim_data, plane, p0, ptds, user=user
...
d2min = 9
 ...
 if(NOT keyword_set(ptds)) then $
   ptds = keyword_set(user) ? grim_get_user_ptd(plane=plane) : grim_ptd(plane)
...
;
;=============================================================================
pro ___grim_activate_select, grim_data, plane, p0, deactivate=deactivate, clicks=clicks, ptd=ptd
