...
;
;=============================================================================
pro grim_rectify_zoom, grim_data

 if(NOT grim_get_toggle_flag(grim_data, 'INTEGER_ZOOM')) then return

 if(grim_data.zoom GT 1) then grim_data.zoom = round(
stop
